...
namespace Tricible
{
	namespace PerlinNoise
	{
		...
		//
		// Description
		// Pour une coordonnée "x", renvoie un bruit interpolé avec le bruit du point "x + 1"
		//
		...
		//
		// Description
		// Pour une coordonnée 2D "x" et "y", renvoie un bruit interpolé avec le bruit des 3 points alentours (x + 1 et/ou y + 1).
		//
		...
		//
		// Description
		// Pour une coordonnée 2D "x" et "y", renvoie un bruit interpolée avec le bruit des 3 points alentours (x + 1 et/ou y + 1).
		// Le bruit interpolé est la résultante de plusieurs bruits superposés
		//
		...
		// SizeBuffer -> taille du buffer passée en paramètre
		...
		// Paramètre :
		// NbrPoint -> Représente le nombre de point par lesquels doit passer la courbe  
		// NbrPerlinNoiseStacked -> nombre de couche de bruit superposé (chaque nouvelle couche augmente le nombre de point -> multipliée par FREQUENCY)
		...
		{
			// TODO PCO : Check if NbrPoint is >= 2
			// TODO PCO : Limiter NbrPerlinNoiseStacked de [2 ; 1024] (1 refusée car reviens à faire PerlinNoise1D(...)
		...
		// SizeBufferX -> Taille du buffer passée en paramètre (axe X uniquement)
		// SizeBufferY -> Taille du buffer passée en paramètre (axe Y uniquement)
		// BufferNoise -> tableau de float. Chaque float varie entre [0 ; 1]
		//
